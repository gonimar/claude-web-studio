...
## Cases
### 1. Happy path
**Fixture**: F-002, GraphQL, Angular. **Expected**: contract ‖ data; backend → frontend; parallel checks; summary.
- [ ] phase order followed · [ ] output matches the expectation · [ ] writes only after consent
### 2. Refusal / BLOCKED
**Fixture**: no feature spec. **Expected**: runs /feature-spec.
- [ ] stops or explicitly flags the limitation · [ ] names the command/reason · [ ] writes no files
### 3. Mode/argument variant
**Fixture**: --review solo → no gates. **Expected**: behaviour differs from case 1 according to the argument.
