# Agent Spec: css-engineer

> **Tier**: frontend · **Spec written**: 2026-09-05

## Summary
**Domain**: Tokens, modern CSS, themes, layouts, typography, motion
...
## Static checks
- [ ] agent file `css-engineer.md` with `name/description/model/tools`
...
### 3. Standard violated — magic numbers / !important outside utilities
**Scenario**: the spec/existing code requires "magic numbers / !important outside utilities". **Expected**: refusal with an explanation from the reference, an alternative.
...
### 5. Context from a parent — tokens from design-system.md
**Scenario**: the context "tokens from design-system.md" is passed. **Expected**: uses it without re-asking, does not expand the task.
