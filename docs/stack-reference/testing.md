...
- Doubles by layer (Go and PHP, layered): none in domain tests; ports only in use-case/application tests (`createMock()` in PHP); real containers in infrastructure tests — `go.md` / `php.md` "Tests by layer".
