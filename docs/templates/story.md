...
## Context
Links to feature-spec/UX-spec/contract sections; what already exists in the code.
...
## Definition of Done
Code + green tests (output) + lint/typecheck + review (`/code-review`) + docs updated + PR.
